...
Previsão de séries temporais é um tema fascinante e com muita aplicabilidade. Para que essa seja bem sucedida é preciso que o método escolhido tenha poder preditido e ao contrário da forma tradicional, que é selecionando o melhor modelo, uma forma eficaz de fazê-lo é por meio de combinações. Foi mostrado uma séries de bons motivos de empregar união de métodos como aumento de acurácia e diminuição de variância.

Além de falar dos motivos, foi mostrado alguns operadores populares junto a exemplos que os empregaram de forma proveitosa. Existem inúmeras aplicações desses operadores, mais ou menos sofisticadas.
